...
![Birthday Site Preview](./image/site-img-1.png)
...
- **Multi-language Support**: English and Arabic (with right-to-left layout)
...
- Replace `aseel.mp3` with your own music file
- **OR** rename your music file to `aseel.mp3`

3. **Update the HTML (if using different filename)**
- Open `index.html`
- Find line 188: `<source src="./music/aseel.mp3" type="audio/mpeg">`
- Change `aseel.mp3` to your music filename
...
### Change Color Theme
1. Click the Settings button on the site
2. Choose from:
- Sweet Pink (default)
- Cool Blue
- Dreamy Purple

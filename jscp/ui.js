...
function showBook() {
    ...
    tapHint.style.textShadow = '0 0 10px #ed1c24, 0 0 20px #142c71';
...
function showConfetti() {
    const confettiColors = ['#ed1c24', '#142c71', '#ffffff', '#0a0a0a', '#3d6fd6'];
...
function spawnHeartPhotosCentered() {
    ...
    function spawnNext() {
        if (currentIndex < maxHeartPhotos) {
            ...
            // Heart photos finished spawning, wait a bit then jump straight to the cake
            setTimeout(() => {
